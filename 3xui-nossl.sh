...
prompt_and_setup_ssl() {
    ...
    1)
        ...
        if ssl_cert_issue; then
            ...
            if [[ -n "${cert_domain}" ]]; then
                ...
                echo -e "${green}вњ“ SSL certificate configured successfully with domain: ${cert_domain}${plain}"
            else
    ...
    2)
        ...
        if [ $? -eq 0 ]; then
            SSL_HOST="${server_ip}"
            echo -e "${green}вњ“ Let's Encrypt IP certificate configured successfully${plain}"
        else
            echo -e "${red}вњ— IP certificate setup failed. Please check port 80 is open.${plain}"
            SSL_HOST="${server_ip}"
        fi
        ;;
    3)
        ...
        custom_domain="${custom_domain// /}" # РЈР±РёСЂР°РµРј РїСЂРѕР±РµР»С‹
        ...
        echo -e "${green}вњ“ Custom certificate paths applied.${plain}"
...
echo ""
echo -e "${green}в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ${plain}"
...
echo -e "${green}в•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђв•ђ${plain}"
echo -e "${yellow}вљ  IMPORTANT: Save these credentials securely!${plain}"
echo -e "${yellow}вљ  SSL Certificate: Disabled in installer patch${plain}"
        else
            local config_webBasePath=$(gen_random_string 18)
            ...
            if [[ -z "${existing_cert}" ]]; then
                echo -e "${yellow}SSL certificate is not configured. Skipping SSL setup by installer patch.${plain}"
...
install_x-ui() {
    ...
    echo -e ""
    echo -e "в”Њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”ђ
в”‚  ${blue}x-ui control menu usages (subcommands):${plain}              в”‚
в”‚                                                       в”‚
в”‚  ${blue}x-ui${plain}              - Admin Management Script          в”‚
в”‚  ${blue}x-ui start${plain}        - Start                            в”‚
в”‚  ${blue}x-ui stop${plain}         - Stop                             в”‚
в”‚  ${blue}x-ui restart${plain}      - Restart                          в”‚
в”‚  ${blue}x-ui status${plain}       - Current Status                   в”‚
в”‚  ${blue}x-ui settings${plain}     - Current Settings                 в”‚
в”‚  ${blue}x-ui enable${plain}       - Enable Autostart on OS Startup   в”‚
в”‚  ${blue}x-ui disable${plain}      - Disable Autostart on OS Startup  в”‚
в”‚  ${blue}x-ui log${plain}          - Check logs                       в”‚
в”‚  ${blue}x-ui banlog${plain}       - Check Fail2ban ban logs          в”‚
в”‚  ${blue}x-ui update${plain}       - Update                           в”‚
в”‚  ${blue}x-ui legacy${plain}       - Legacy version                   в”‚
в”‚  ${blue}x-ui install${plain}      - Install                          в”‚
в”‚  ${blue}x-ui uninstall${plain}    - Uninstall                        в”‚
